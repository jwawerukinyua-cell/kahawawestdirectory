  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-[#4D0202] text-white px-5 py-3.5 flex items-center justify-between border-b border-[#630303] flex-shrink-0">
          <button
            onClick={onClose}
            className="inline-flex items-center gap-2 text-xs font-semibold text-stone-200 hover:text-white px-3 py-1.5 rounded-xl bg-[#630303] hover:bg-[#7D0404] transition"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Directory
          </button>

          <div className="text-xs text-sky-300 font-mono hidden sm:block">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleShare}
              className="p-2 rounded-xl bg-[#630303] hover:bg-[#7D0404] text-stone-200 hover:text-white transition"
              title="Share listing"
            >
